...
class FlowRouter {
    ...
    */
	init(){
        ...
        let {flowUX, litHtml, lit, at_lit, litElement, sockjs, webcomponents} = this.mount;

        this.urlProxies = [
            {url:"/node_modules/@aspectron/flow-ux", proxyUrl:flowUX},
            {url:"/node_modules/lit-html", proxyUrl:litHtml},
            {url:"/node_modules/lit", proxyUrl:lit},
            {url:"/node_modules/@lit", proxyUrl:at_lit},
        ...
        this.app.use(flowUX, this.router(this.sources.flowUX));
        this.app.use(litHtml, this.router(this.sources.litHtml));
        this.app.use(lit, this.router(this.sources.lit));
        this.app.use(at_lit, this.router(this.sources.at_lit));
        this.app.use(litElement, this.router(this.sources.litElement));
        this.app.use(litHtml, serveStatic(path.join(this.rootFolder, this.sources.litHtml)));
        this.app.use(litElement, serveStatic(path.join(this.rootFolder, this.sources.litElement)));
        this.app.use(sockjs, serveStatic(path.join(this.rootFolder, this.sources.sockjs)));
        this.app.use(webcomponents, serveStatic(path.join(this.rootFolder, this.sources.webcomponents)));
    }
    router(folder){
        return (req, res, next)=>{
